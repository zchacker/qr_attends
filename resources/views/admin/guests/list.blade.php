                    ...
                    <div class="px-4">
                        <div class="flex justify-between sm:flex sm:items-center">
                            ...
                            <div class="w-1/3 flex gap-4 justify-end">
                                <div>
                                    <a href="{{ route('admin.export.csv') }}" class="download_button">تحميل ملف CSV</a>
                                </div>
                                <div >
                                    <a href="{{ route('admin.guest.create') }}" class="normal_button">إضافة عضو</a>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody class="table_body">
                                        ...
                                        <tr data-href="" class="clickable-row cursor-pointer hover:bg-gray-200">
                                            ...
                                            <td class="relative flex gap-4 justify-between whitespace-nowrap py-4 pl-3 pr-4 text-right text-sm font-medium sm:pr-6 md:pr-0">
                                                ...
                                                {{--
                                                @php 
                                                    $qr = base64_encode( QrCode::size(300)->format('png')->generate(Request::url()) );
                                                @endphp
